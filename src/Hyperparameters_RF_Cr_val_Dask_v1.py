...
# In[6]:
train = ddf[~ddf["cell_line"].isin(subCh1)]
test = ddf[ddf["cell_line"].isin(subCh1)]
...
base_model.save_model('base_line_no_max_deph_%s.model'%( rounds[choice]["test"][0] ) )
#    
...
p.to_csv("my_result_for_%s_SubCh1"%(rounds[choice]["test"][0]))
